...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
			...
			<tr>
				<td>
					<div id="displaybatchprodnBundle" runat="server">
						<asp:Label runat="server" AssociatedControlID="grdvbatchprodnBundle" Visible="true" ID="Label1" CssClass="h2">Bundles to be checked</asp:Label>
	...
	<asp:HyperLinkField Text="Select"
				...
				<td>
					<div id="displayprodnBundlesChecked" runat="server">
						<asp:Label runat="server" AssociatedControlID="grdvprodnBundlesChecked" Visible="true" ID="lblOpenTickets" CssClass="h2">Bundles Checked</asp:Label>
						<asp:GridView ID="grdvprodnBundlesChecked" runat="server" Visible="False" CellPadding="5" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" CellSpacing="1" PageSize="15">
							<AlternatingRowStyle BackColor="White" />
							<EditRowStyle BackColor="#7C6F57" />
							<FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
							<HeaderStyle BackColor="#03A5D1" Font-Bold="False" ForeColor="White" />
